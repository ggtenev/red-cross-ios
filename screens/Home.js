...
import { StyleSheet, Image, ScrollView, Alert, ImageBackground, TouchableOpacity, View, Dimensions,  } from 'react-native';
...
export default class Home extends React.Component {
  ...
  //    Alert.alert(
  //      'ВНИМАНИЕ',
  //      'Българският Червен кръст моли всички да предприемат необходимите мерки за справяне с COVID-19',[{
  //      text:'Прочети',
  ...
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      />,
      headerRight: () => (
        <TouchableOpacity style={{ padding: 5, marginBottom:3}} onPress={() => navigation.navigate('About')}>
  ...
  render() {
    const windows = Dimensions.get('window').width
    const args = {
    ...
    return (
      <Container>
        ...
        <Content>
          <Image
            style={{ width: '100%', height: windows > 600 ? 480 : 260 }}
